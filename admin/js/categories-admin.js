                ...
                <tr style="background-color: #f8f9fa;">
                    ...
                    <td>
                        <div class="table-actions">
                            ...
                            <button class="btn btn-danger btn-sm" onclick='deleteCategory("${parent.id}", "${parent.name.replace(/"/g, "&quot;").replace(/'/g, "&#39;")}");'>
                                Delete
                            </button>
                        </div>
                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <button class="btn btn-danger btn-sm" onclick='deleteCategory("${sub.id}", "${sub.name.replace(/"/g, "&quot;").replace(/'/g, "&#39;")}");'>
                                    Delete
                                </button>
                            </div>
                        </td>
